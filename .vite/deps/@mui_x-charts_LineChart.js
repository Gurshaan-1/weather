...
var React6, syncFallback, useInsertionEffect2, useInsertionEffectAlwaysWithSyncFallback, useInsertionEffectWithLayoutFallback;
var init_emotion_use_insertion_effect_with_fallbacks_browser_esm = __esm({
  "node_modules/@emotion/use-insertion-effect-with-fallbacks/dist/emotion-use-insertion-effect-with-fallbacks.browser.esm.js"() {
    ...
    useInsertionEffect2 = React6["useInsertionEffect"] ? React6["useInsertionEffect"] : false;
    useInsertionEffectAlwaysWithSyncFallback = useInsertionEffect2 || syncFallback;
    useInsertionEffectWithLayoutFallback = useInsertionEffect2 || React6.useLayoutEffect;
  }
});

// node_modules/@emotion/react/dist/emotion-element-43c6fea0.browser.esm.js
var React7, import_react, isBrowser2, hasOwn, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, typePropName, labelPropName, Insertion, Emotion;
var init_emotion_element_43c6fea0_browser_esm = __esm({
  "node_modules/@emotion/react/dist/emotion-element-43c6fea0.browser.esm.js"() {
    ...
    EmotionCacheContext = React7.createContext(
      ...
      withEmotionCache = function withEmotionCache3(func) {
        return function(props) {
          ...
          if (cache2 === null) {
            ...
            return React7.createElement(EmotionCacheContext.Provider, {
              value: cache2
            }, func(props, cache2));
          } else {
    ...
    ThemeContext = React7.createContext({});
    if (true) {
...
var React8, import_hoist_non_react_statics2, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Insertion3, ClassNames, isBrowser3, isTestEnv, globalContext, globalKey;
  ...
  "node_modules/@emotion/react/dist/emotion-react.browser.esm.js"() {
    ...
    Global = withEmotionCache(function(props, cache2) {
      ...
      if (!isBrowser2) {
        ...
        return React8.createElement("style", (_ref = {}, _ref["data-emotion"] = cache2.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
          __html: rules
...
var React9, testOmitPropsOnStringTag, testOmitPropsOnComponent, getDefaultShouldForwardProp, composeShouldForwardProps, ILLEGAL_ESCAPE_SEQUENCE_ERROR2, Insertion5, createStyled;
...
var React10, import_prop_types, import_jsx_runtime2, cache;
...
var React11, import_prop_types2, import_jsx_runtime3;
...
The following color spaces are supported: srgb, display-p3, a98-rgb, prophoto-rgb, rec-2020.` : (0, _formatMuiErrorMessage2.default)(10, colorSpace));
    ...
    function getLuminance2(color3) {
      color3 = decomposeColor2(color3);
      let rgb2 = color3.type === "hsl" || color3.type === "hsla" ? decomposeColor2(hslToRgb4(color3)).values : color3.values;
      rgb2 = rgb2.map((val) => {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const ctx2 = React34.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React34.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime12.jsxs)(React34.Fragment, {
...
function createGrid(options = {}) {
  ...
  const Grid2 = React36.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime14.jsx)(GridRoot2, _extends({
      ref,
      as: component,
      ownerState,
      className: clsx_default(classes.root, className)
...
function CartesianContextProvider(props) {
  ...
  const xAxis = React43.useMemo(() => normalizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React43.useMemo(() => normalizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  const xValues = React43.useMemo(() => computeValue(drawingArea, formattedSeries, xAxis, xExtremumGetters, "x"), [drawingArea, formattedSeries, xAxis, xExtremumGetters]);
  const yValues = React43.useMemo(() => computeValue(drawingArea, formattedSeries, yAxis, yExtremumGetters, "y"), [drawingArea, formattedSeries, yAxis, yExtremumGetters]);
...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime20.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function HighlightedProvider({
  ...
  return (0, import_jsx_runtime21.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
var useAnimatedPath = (path, skipAnimation2) => {
  ...
  const interpolator = React56.useMemo(() => previousPath ? string_default(previousPath, path) : () => path, [previousPath, path]);
  const {
    value
  } = useSpring({
    from: {
...
function AnimatedArea(props) {
  ...
  return (0, import_jsx_runtime23.jsxs)(React60.Fragment, {
    children: [(0, import_jsx_runtime23.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime23.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top3 + height2 + bottom3
      })
    }), (0, import_jsx_runtime23.jsx)("g", {
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime23.jsx)(AreaElementPath, _extends({}, other, {
        ownerState,
        d: path
      }))
    })]
...
function AreaElement(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(Area, _extends({}, other, areaProps));
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime25.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index) => {
      ...
      return (0, import_jsx_runtime25.jsxs)(React62.Fragment, {
...
function AreaPlot(props) {
  ...
  return (0, import_jsx_runtime28.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      area,
      gradientUsed
    }) => !!area && (0, import_jsx_runtime28.jsx)(AreaElement, {
      id: seriesId,
      d,
      color: color3,
...
function AnimatedLine(props) {
  ...
  return (0, import_jsx_runtime29.jsxs)(React66.Fragment, {
    children: [(0, import_jsx_runtime29.jsx)("clipPath", {
      id: clipId,
      children: (0, import_jsx_runtime29.jsx)(animated.rect, {
        x: 0,
        y: 0,
        width: animatedWidth,
        height: top3 + height2 + bottom3
      ...
      clipPath: `url(#${clipId})`,
      children: (0, import_jsx_runtime29.jsx)(LineElementPath, _extends({}, other, {
        ownerState,
        d: path
      }))
    })]
...
function LineElement(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(Line, _extends({}, other, lineProps));
}
...
function LinePlot(props) {
  ...
  return (0, import_jsx_runtime31.jsx)("g", _extends({}, other, {
    children: completedData.map(({
      ...
      return (0, import_jsx_runtime31.jsx)(LineElement, {
        id: seriesId,
        d,
        color: color3,
        gradientId: gradientUsed && getGradientId(...gradientUsed),
...
var ColorContext = React69.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime32.jsx)(ColorContext.Provider, {
...
var ChartsSurface = React71.forwardRef(function ChartsSurface2(props, ref) {
  const {
    children,
    width: width2,
    height: height2,
  ...
  return (0, import_jsx_runtime33.jsxs)(ChartChartsSurfaceStyles, _extends({
    ...
    children: [(0, import_jsx_runtime33.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime33.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var useChartContainerHooks = (ref, plugins) => {
  const svgRef = React73.useRef(null);
...
var ChartContainer = React74.forwardRef(function ChartContainer2(props, ref) {
  const {
    width: width2,
    height: height2,
    series,
  ...
  return (0, import_jsx_runtime34.jsx)(DrawingProvider, {
    ...
    margin: margin2,
    svgRef,
    children: (0, import_jsx_runtime34.jsx)(ColorProvider, {
      colorProcessors,
      children: (0, import_jsx_runtime34.jsx)(SeriesContextProvider, {
        ...
        children: (0, import_jsx_runtime34.jsx)(CartesianContextProvider, {
          ...
          xExtremumGetters,
          yExtremumGetters,
          children: (0, import_jsx_runtime34.jsx)(ZAxisContextProvider, {
            zAxis,
            dataset,
            children: (0, import_jsx_runtime34.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime34.jsx)(HighlightedProvider, {
                highlightedItem,
                onHighlightChange,
                children: (0, import_jsx_runtime34.jsxs)(ChartsSurface, {
                  width: width2,
                  height: height2,
                  ref: handleRef,
                  sx,
                  ...
                  desc,
                  disableAxisListener,
                  children: [(0, import_jsx_runtime34.jsx)(ChartsAxesGradients, {}), children]
                })
              })
            })
          })
...
true ? ChartContainer.propTypes = {
   ...
   * The height of the chart in px.
   */
  height: import_prop_types31.default.number.isRequired,
  /**
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
...
var useChartContainerDimensions = (inWidth, inHeight) => {
  ...
  const displayError = React75.useRef(false);
  const [width2, setWidth] = React75.useState(0);
  const [height2, setHeight] = React75.useState(0);
  const computeSize = React75.useCallback(() => {
...
var ResponsiveChartContainer = React76.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
  ...
  return (0, import_jsx_runtime35.jsx)(ResizableContainer, {
    ...
    children: width2 && height2 ? (0, import_jsx_runtime35.jsx)(ChartContainer, _extends({}, other, {
      width: width2,
      height: height2,
      ref
    })) : null
...
true ? ResponsiveChartContainer.propTypes = {
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types32.default.arrayOf(import_prop_types32.default.object),
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
...
function MarkElement(props) {
  ...
  return (0, import_jsx_runtime36.jsx)(MarkElementPath, _extends({}, other, {
    style: {
...
function MarkPlot(props) {
  ...
  const defaultXAxisId = xAxisIds[0];
  const defaultYAxisId = yAxisIds[0];
  return (0, import_jsx_runtime37.jsx)("g", _extends({}, other, {
      ...
      return groupIds.map((seriesId) => {
        ...
        return (0, import_jsx_runtime37.jsx)("g", {
          ...
          children: xData == null ? void 0 : xData.map((x, index) => {
            ...
            return (0, import_jsx_runtime37.jsx)(Mark, _extends({
              id: seriesId,
              dataIndex: index,
              shape: "circle",
...
function ChartsText(props) {
  ...
  const wordsByLines = React79.useMemo(() => getWordsByLines({
    style: style4,
...
function ChartsXAxis(inProps) {
  ...
  const _xAxis = xAxis[inProps.axisId ?? xAxisIds[0]], {
    ...
    tickNumber,
    reverse
  } = _xAxis, settings = _objectWithoutPropertiesLoose(_xAxis, _excluded34);
  ...
  return (0, import_jsx_runtime39.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime39.jsx)(Line, _extends({
    ...
    }, slotProps == null ? void 0 : slotProps.axisLine)), xTicksWithDimension.filter((tick) => tick.offset >= left3 - 1 && tick.offset <= left3 + width2 + 1).map(({
      formattedValue,
      offset: offset2,
      labelOffset,
      skipLabel
      ...
      const showTick = offset2 >= left3 - 1 && offset2 <= left3 + width2 + 1;
      const showTickLabel = offset2 + xTickLabel >= left3 - 1 && offset2 + xTickLabel <= left3 + width2 + 1;
...
function ChartsYAxis(inProps) {
  ...
  const _yAxis = yAxis[inProps.axisId ?? yAxisIds[0]], {
    scale: yScale,
    tickNumber
  } = _yAxis, settings = _objectWithoutPropertiesLoose(_yAxis, _excluded35);
  const themedProps = useThemeProps2({
    props: _extends({}, settings, inProps),
    name: "MuiChartsYAxis"
  });
  ...
  return (0, import_jsx_runtime40.jsxs)(AxisRoot, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)(React83.Fragment, {
...
var Portal = React84.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React84.useState(null);
  const handleRef = useForkRef(React84.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React84.isValidElement(children)) {
      ...
      return React84.cloneElement(children, newProps);
    }
    return (0, import_jsx_runtime42.jsx)(React84.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime42.jsx)(React84.Fragment, {
...
var PopperTooltip = React85.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children,
  ...
  const handlePopperRefRef = React85.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React85.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React85.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React85.useState(resolveAnchorEl(anchorEl));
  React85.useEffect(() => {
...
var Popper = React85.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
  ...
  return (0, import_jsx_runtime43.jsx)(Portal, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime43.jsx)(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime44.jsx)(React86.Fragment, {
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React87.useState(null);
  React87.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime45.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime45.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime45.jsx)("tbody", {
        children: (0, import_jsx_runtime45.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime45.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime45.jsx)(ChartsTooltipMark, {
              color: color3,
...
function useColorProcessor(seriesType) {
  const colorProcessors = React89.useContext(ColorContext);
  if (!seriesType) {
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React90.useContext(ZAxisContext);
...
var Typography = React91.forwardRef(function Typography2(inProps, ref) {
  ...
  return (0, import_jsx_runtime47.jsx)(TypographyRoot, _extends({
    as: Component,
    ref,
    ownerState,
    className: clsx_default(classes.root, className)
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime48.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime48.jsx)("thead", {
        children: (0, import_jsx_runtime48.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime48.jsx)(ChartsTooltipCell, {
            colSpan: 3,
      ...
      }), (0, import_jsx_runtime48.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime48.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime48.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime48.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime48.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime48.jsx)(Typography_default, {
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React93.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React93.useMemo(() => {
  ...
  return (0, import_jsx_runtime49.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(NoSsr, {
    children: popperOpen && (0, import_jsx_runtime50.jsx)(PopperComponent, _extends({}, popperProps, {
      children: trigger === "item" ? (0, import_jsx_runtime50.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime50.jsx)(ChartsAxisTooltipContent, {
...
function DefaultChartsLegend(props) {
  ...
  const theme = useTheme5();
  const isRTL = theme.direction === "rtl";
  const labelStyle = React95.useMemo(
  ...
  const padding2 = React95.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React95.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React95.useMemo(() => {
    let x = 0;
    let y = 0;
  ...
  return (0, import_jsx_runtime51.jsx)(NoSsr, {
    children: (0, import_jsx_runtime51.jsx)(ChartsLegendRoot, {
      className: classes.root,
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime53.jsxs)(React97.Fragment, {
...
function LineHighlightPlot(props) {
  ...
  const {
    axis
  } = React100.useContext(InteractionContext);
...
function ChartsGrid(props) {
  ...
  return (0, import_jsx_runtime57.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
...
function ChartsOnAxisClickHandler(props) {
  ...
  return (0, import_jsx_runtime58.jsx)(React102.Fragment, {});
}
...
var LineChart = React106.forwardRef(function LineChart2(props, ref) {
  const {
    chartContainerProps,
    axisClickHandlerProps,
    gridProps,
  ...
  return (0, import_jsx_runtime62.jsxs)(ResponsiveChartContainer, _extends({
    ...
    children: [props.onAxisClick && (0, import_jsx_runtime62.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), props.grid && (0, import_jsx_runtime62.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime62.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime62.jsx)(AreaPlot, _extends({}, areaPlotProps)), (0, import_jsx_runtime62.jsx)(LinePlot, _extends({}, linePlotProps)), (0, import_jsx_runtime62.jsx)(ChartsOverlay, _extends({}, overlayProps))]
    })), (0, import_jsx_runtime62.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime62.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime62.jsx)(MarkPlot, _extends({}, markPlotProps)), (0, import_jsx_runtime62.jsx)(LineHighlightPlot, _extends({}, lineHighlightPlotProps)), (0, import_jsx_runtime62.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime62.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime62.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? LineChart.propTypes = {
   ...
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types54.default.shape({
    dataIndex: import_prop_types54.default.number,
    seriesId: import_prop_types54.default.oneOfType([import_prop_types54.default.number, import_prop_types54.default.string])
  }),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   ...
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   */
  onHighlightChange: import_prop_types54.default.func,
  /**
  ...
  yAxis: import_prop_types54.default.arrayOf(import_prop_types54.default.shape({
    ...
    max: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]),
    min: import_prop_types54.default.oneOfType([import_prop_types54.default.instanceOf(Date), import_prop_types54.default.number]),
    position: import_prop_types54.default.oneOf(["left", "right"]),
    reverse: import_prop_types54.default.bool,
    scaleType: import_prop_types54.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types54.default.object,
    slots: import_prop_types54.default.object,
